...
def test_store_param():
    ...
    client = AsyncOpenAI()
    assert (
        ChatCmplHelpers.get_store_param(client, model_settings) is True
    ), "Should default to True for OpenAI API calls"

    model_settings = ModelSettings(store=False)
    assert (
        ChatCmplHelpers.get_store_param(client, model_settings) is False
    ...
    model_settings = ModelSettings()
    assert (
        ChatCmplHelpers.get_store_param(client, model_settings) is None
